...
export function SideBar() {
    ...
    useEffect(() => {
        let resp = new LocalStorageSite().obterLocalstorage();
        console.log(resp)
        if (resp) {
            setShow(true)
        }
    ...
    return (
        <>
            {show ?
                <nav className="bg-slate-200 shadow-lg h-screen fixed top-0 left-0 min-w-[240px] py-6 px-4 font-[sans-serif] overflow-auto">
                    <ul>
                        <li>
