            ...
            <div className="py-4 px-4">
              ...
              <ul className="space-y-2 mt-6">
                ...
                <li>
                  <a href="javascript:void(0)"
                    ...
                    <span className="overflow-hidden text-ellipsis whitespace-nowrap">Posts</span>
                    <svg xmlns="http://www.w3.org/2000/svg"
                ...
                <li>
                  <a href="javascript:void(0)"
                    ...
                    <span className="overflow-hidden text-ellipsis whitespace-nowrap">Audience</span>
                    <svg xmlns="http://www.w3.org/2000/svg"
                      className="arrowIcon w-2.5 h-2.5 fill-current -rotate-90 ml-auto transition-all duration-500"
                      viewBox="0 0 451.847 451.847">
                      <path
              ...
              <div>
                ...
                <div className="mt-6 flex items-center cursor-pointer">
                  ...
                  <div className="ml-4">
                    <p className="text-sm text-gray-300 whitespace-nowrap">John Doe</p>
        ...
        <section className="main-content w-full p-6 max-lg:ml-8">
          <div>
            <div className="flex items-center flex-wrap gap-6">
              <div>
                <h3 className="text-lg font-semibold text-white">Bem vindo ,EEE</h3>
                <p className="text-xs text-gray-300">Streamlined dashboard layout featuring a welcoming header for user
                  personalization.</p>
              </div>
